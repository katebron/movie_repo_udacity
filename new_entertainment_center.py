...
fargo = media.Movie("Fargo","Mad-cap yet violent Coen brothers "
                    " thriller set in Minnesota",
...
logans_run = media.Movie("Logan's Run", "A future where people who reach"
                         " the age of 30 transcend to another place",
...
boyhood = media.Movie("Boyhood","A look at the same boy and family, filmed over "
                      " 12 years.",
